...
public class BaseRedisHelper<T> {
	...
	/**
	 * This constructor constructs the RedisUtil object by referring Redis template
	 * to utilize as common functionality
	 * 
	...
	/**
	 * This method will be used to put Map against the RedisKey - hash operation for
	 * map
	 * 
	...
	/**
	 * This method will be used to get Map against the RedisKey - hash operation for
	 * map
	 * 
	 * @param redisKey Redis key
	 * @param mapKey   map key
	...
	/**
	 * This method will put the value against key with expiration time - value
	 * operation
	 * 
	 * @param redisKey Redis key
	 * @param value    value
